...
export function CreateTicketForm({ onSuccess, onClose }: CreateTicketFormProps) {
  ...
  return (
    <ComicDialog className="w-full max-w-4xl" onClose={onClose}>
      <Form {...form}>
        <form 
          onSubmit={(e) => {
          ...
          className="space-y-6"
        >
          <h2 className="text-2xl font-comic font-bold mb-6">Create Support Ticket</h2>
